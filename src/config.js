...
function shouldFlatten() {
    return context.workspaceState.get(
        'flat',
        vscode.workspace.getConfiguration('todo-tree.tree').get('flat', false)
    );
}
...
function shouldShowCounts() {
    return vscode.workspace
        .getConfiguration('todo-tree.tree')
        .get('showCountsInTree', false);
}

function shouldHideIconsWhenGroupedByTag() {
    return vscode.workspace
        .getConfiguration('todo-tree.tree')
        .get('hideIconsWhenGroupedByTag', false);
}

function showFilterCaseSensitive() {
    return vscode.workspace
        .getConfiguration('todo-tree.tree')
        .get('filterCaseSensitive', false);
}

function isRegexCaseSensitive() {
    return vscode.workspace
        .getConfiguration('todo-tree.regex')
        .get('regexCaseSensitive', true);
}

function showBadges() {
    return vscode.workspace
        .getConfiguration('todo-tree.tree')
        .get('showBadges', false);
}

function regex() {
    return {
        tags: tags(),
        regex: vscode.workspace
            .getConfiguration('todo-tree.regex')
            .get('regex'),
        caseSensitive: vscode.workspace
            .getConfiguration('todo-tree.regex')
            .get('regexCaseSensitive'),
        multiLine: vscode.workspace
            .getConfiguration('todo-tree.regex')
            .get('enableMultiLine'),
    };
}
...
function shouldSortTagsOnlyViewAlphabetically() {
    return vscode.workspace.getConfiguration('todo-tree.tree')
...
function clickingStatusBarShouldRevealTree() {
    return (
        vscode.workspace.getConfiguration('todo-tree.general')
            .statusBarClickBehaviour === 'reveal'
    );
}
...
function clickingStatusBarShouldToggleHighlights() {
    return (
        vscode.workspace.getConfiguration('todo-tree.general')
            .statusBarClickBehaviour === 'toggle highlights'
    );
}

function isValidScheme(uri) {
    var schemes =
        vscode.workspace.getConfiguration('todo-tree.general').schemes;
    return (
        uri &&
        uri.scheme &&
        schemes &&
        schemes.length &&
        schemes.indexOf(uri.scheme) !== -1
    );
}

function shouldUseBuiltInFileExcludes() {
    var useBuiltInExcludes = vscode.workspace.getConfiguration(
        'todo-tree.filtering'
    ).useBuiltInExcludes;
    return (
        useBuiltInExcludes === 'file exclude' ||
...
function shouldUseBuiltInSearchExcludes() {
    ...
    return (
        useBuiltInExcludes === 'search excludes' ||
        useBuiltInExcludes === 'file and search excludes'
    );
}

function shouldIgnoreGitSubmodules() {
    return vscode.workspace.getConfiguration('todo-tree.filtering')
        .ignoreGitSubmodules;
}

function refreshTagGroupLookup() {
    var tagGroups =
        vscode.workspace.getConfiguration('todo-tree.general').tagGroups;
...
function shouldUseColourScheme() {
    return vscode.workspace.getConfiguration('todo-tree.highlights')
        .useColourScheme;
}
...
function shouldShowIconsInsteadOfTagsInStatusBar() {
    return vscode.workspace.getConfiguration('todo-tree.general')
        .showIconsInsteadOfTagsInStatusBar;
}
...
module.exports.shouldHideIconsWhenGroupedByTag =
    shouldHideIconsWhenGroupedByTag;
...
module.exports.shouldSortTagsOnlyViewAlphabetically =
    shouldSortTagsOnlyViewAlphabetically;
module.exports.labelFormat = labelFormat;
module.exports.tooltipFormat = tooltipFormat;
module.exports.clickingStatusBarShouldRevealTree =
    clickingStatusBarShouldRevealTree;
module.exports.clickingStatusBarShouldToggleHighlights =
    clickingStatusBarShouldToggleHighlights;
...
module.exports.shouldShowIconsInsteadOfTagsInStatusBar =
    shouldShowIconsInsteadOfTagsInStatusBar;
