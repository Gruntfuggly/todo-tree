...
`icon` - changes the default tree view icon. Must be a valid ['octicon'](https://octicons.github.com/) or ['codicon'](https://github.com/microsoft/vscode-codicons) - however ['codicons'](https://github.com/microsoft/vscode-codicons) are wrapped `$(icon)`. If invalid, the default 'tick' icon is used. You may also use "todo-tree", or "todo-tree-filled" if you wish to use the activity view icon. 
